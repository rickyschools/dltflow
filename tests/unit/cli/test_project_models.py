...
from dltflow.cli.models.project import ProjectInfo, PathName, ProjectElements, Workspace, Environment, ProjectConfig
...
def test_workspace():
    ...
    workspace = Workspace(host='localhost', root_path='/root', artifact_path='/artifacts')
...
def test_project_config():
    ...
    project_config = ProjectConfig(dltflow=ProjectInfo(name='my_project'), include=elements, targets=targets)
